...
export const ChangeProjectSection: FC<ChangeProjectSectionProps> = ({ className }) => {
  ...
  // const contentHTML = { __html: projectListData[projectKey2].content }

  useEffect(() => {
    setProjectContent(projectListData[projectKey2].content)
  }, [])
  return (
    <Root className={className}>
      <InputTitleRequired type="primary" onClick={onClickChangeProject}>
        수정하기
      </InputTitleRequired>
      <ReactQuillStyled
        modules={modules}
